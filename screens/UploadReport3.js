    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{flexDirection:'row'}}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate("Report4", { dimer: route.params.dimer, cpr: route.params.cpr, bloodcp:image })} style={{ flexDirection: 'row', alignSelf: 'center', justifyContent: 'flex-end', }}>
