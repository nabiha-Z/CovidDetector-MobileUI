...
export default function UploadReport({ route, navigation }) {
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.heading}>Chest X-Ray Report</Text>
            ...
            <View style={[styles.nextBtn, { width: width * 0.9 }]}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate("Report5", { dimer: route.params.dimer, cpr: route.params.cpr, bloodcp: route.params.bloodcp, xray:image })} style={{ flexDirection: 'row', alignSelf: 'center', justifyContent: 'flex-end', }}>
