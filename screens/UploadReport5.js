...
export default function UploadReport({ route, navigation }) {
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.heading}>HR-CT Reprt</Text>
            <Text style={{ color: '#A3A5A7', extAlign: 'center', marginLeft: 10 }}>Upload The File Report</Text>
            ...
            <View style={[styles.nextBtn, { width: width * 0.9 }]}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate("AllReports", { dimer: route.params.dimer, cpr: route.params.cpr, bloodcp: route.params.bloodcp, xray:route.params.xray, hrct: image })} style={{ flexDirection: 'row', alignSelf: 'center', justifyContent: 'flex-end', }}>
